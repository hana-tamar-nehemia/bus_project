...
namespace dotNet5781_02_8113_5037
{
    public class Bus_line : IComparable<Bus_line>
    {
        ...
        public enum AreaEnum{center=0,north,jerusalem,haifa,galil}
        public string area; 
        ...
        {
            get { return Time_between_2_station(first_station, Last_station); }
            set
            {
        ...
        //{
        //    TimeSpan a = Bus_line.Time_between_2_station(first, this);
        ...
        /// if there are line that go to two side than we print the two route
        /// </summary>
        ...
        //        for (int k = 0; k < i; k++)
        //        {
        //            Console.WriteLine(stations[k].ToString());
        //        }
        //    }
        //    return "";
        //}
